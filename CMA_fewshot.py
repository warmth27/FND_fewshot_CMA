...
# from my_datautils import FakeNews_Dataset, FewShotSampler_fakenewsnet, FewShotSampler_DGM4
from mymodels import Adapter_Origin, Adapter_V1
from utils import DGM4_Dataset, FewShotSampler_DGM4, DGM4_Dataset_Test
...
if __name__ == "__main__":
        ...
        parser.add_argument("--train_path", type=str, help="this is your train directory")
        parser.add_argument("--test_path", type=str, help="this is your test directory")
        ...
        seed = args.seed
        print(f"****** SHOT : {args.shot} | SEED : {seed} ******")
        ...
        if data_name == "weibo":
            ...
            train_dataset = DGM4_Dataset(args.train_path, "binary")
            test_dataset = DGM4_Dataset_Test(args.test_path, "binary")

            train_sampler = FewShotSampler_DGM4(train_dataset, args.shot, seed)

            train_dataset = train_sampler.get_train_val_datasets()
        ...
        for epoch in range(EPOCH):
            ...
            if epoch_acc > best_test_acc_in_epoch:
                ...
                print("saving best model at Epoch {} | Accuracy {}".format(epoch+1, best_test_acc_in_epoch))
